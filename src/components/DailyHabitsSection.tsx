    ...
    return (
        <div className={`p-4 sm:p-6 animate-fade-in pb-32 min-h-screen ${dm ? 'bg-slate-900 text-slate-100' : 'bg-[#fafafa] text-gray-800'}`}>
            ...
            <div className="text-center pt-8 mb-8">
                ...
                <h2 className={`text-3xl font-extrabold tracking-tight mb-2 ${dm ? 'text-emerald-400' : 'text-emerald-700'}`}>Meus Hábitos</h2>
                            ...
                            {myHabits.map(habit => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`w-full flex items-center gap-4 p-4 rounded-3xl transition-all duration-300 active:scale-[0.98] border shadow-sm ${isDone
                                    ...
                                    {category.items.map(item => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`p-4 rounded-2xl border flex items-center justify-between text-left transition-all active:scale-95 ${isAdded
