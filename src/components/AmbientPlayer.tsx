                ...
                <div className="px-4 pb-3 border-b border-gray-100">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            {playingItem && (
                                <button onClick={stopAll} className="px-3 py-1.5 bg-red-100 text-red-600 rounded-lg text-xs font-medium">
                                    ⏹ Parar
                                </button>
                            )}
                    ...
                    {filteredSounds.length === 0 ? (
                        ...
                        filteredSounds.map(sound => (
                            ...
                            >
                                ...
                                <button onClick={() => toggleFavorite(sound.id)} className="p-2 rounded-lg hover:bg-white/50 transition-colors">
                                    <span className={`text-lg ${favorites.includes(sound.id) ? '' : 'opacity-30'}`}>
